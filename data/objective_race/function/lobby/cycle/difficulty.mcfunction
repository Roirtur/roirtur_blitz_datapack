...
execute if score #difficulty or_lobby matches 0 run function objective_race:settings/difficulty_easy
...
execute if score #difficulty or_lobby matches 1 run function objective_race:settings/difficulty_balanced
...
execute if score #difficulty or_lobby matches 2 run function objective_race:settings/difficulty_chaos
...
execute if score #difficulty or_lobby matches 3 run function objective_race:settings/difficulty_hardcore

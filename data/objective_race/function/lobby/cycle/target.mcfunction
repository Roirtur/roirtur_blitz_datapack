...
execute if score #target or_lobby matches 0 run function objective_race:settings/target_3
...
execute if score #target or_lobby matches 1 run function objective_race:settings/target_5
...
execute if score #target or_lobby matches 2 run function objective_race:settings/target_7
...
execute if score #target or_lobby matches 3 run function objective_race:settings/target_10

...
# Apply defaults.
function objective_race:settings/target_5
function objective_race:settings/time_600
function objective_race:settings/mode_shared
function objective_race:settings/difficulty_balanced
function objective_race:settings/keep_inventory_on
...
function objective_race:lobby/set

tellraw @s {text:'Minimal clean Objective Race lobby rebuilt.',color:'green'}

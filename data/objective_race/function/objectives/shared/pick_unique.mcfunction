...
execute if score #repeat orace_tmp matches 1.. if score #reroll orace_tmp matches ..10 run function objective_race:objectives/shared/pick_unique
execute if score #picked orace_tmp matches 1.. run return 0
...
execute as @a[tag=orace.active] run function objective_race:objectives/shared/init_current
function objective_race:ui/show_current_objective

...
bossbar add objective_race:round {"text":"Objective Race","color":"gold"}
bossbar set objective_race:round color yellow
bossbar set objective_race:round style notched_10
bossbar set objective_race:round visible false
...
execute if score #state orace_state matches 1..2 run bossbar set objective_race:round visible true
...
execute if score #state orace_state matches 2 if score #mode orace_mode matches 1 run function objective_race:ui/list_sidebar_refresh

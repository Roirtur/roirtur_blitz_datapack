...
execute store result bossbar roirtur_blitz:orace_timer max run scoreboard players get #round_time orace_round
execute store result bossbar roirtur_blitz:orace_timer value run scoreboard players get #round_time orace_round

...
execute if score #time or_lobby matches 0 run function roirtur_blitz:games/objective_race/settings/time_300
...
execute if score #time or_lobby matches 1 run function roirtur_blitz:games/objective_race/settings/time_600
...
execute if score #time or_lobby matches 2 run function roirtur_blitz:games/objective_race/settings/time_900
...
execute if score #time or_lobby matches 3 run function roirtur_blitz:games/objective_race/settings/time_1200
...
execute if score #time or_lobby matches 4 run function roirtur_blitz:games/objective_race/settings/time_unlimited

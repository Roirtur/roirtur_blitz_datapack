...
execute if score #keepinv or_lobby matches 0 run function roirtur_blitz:games/objective_race/settings/keep_inventory_on
...
execute if score #keepinv or_lobby matches 1 run function roirtur_blitz:games/objective_race/settings/keep_inventory_off

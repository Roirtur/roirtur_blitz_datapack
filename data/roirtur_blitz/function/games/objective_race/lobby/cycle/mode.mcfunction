...
execute if score #mode or_lobby matches 0 run function roirtur_blitz:games/objective_race/settings/mode_shared
...
execute if score #mode or_lobby matches 1 run function roirtur_blitz:games/objective_race/settings/mode_list

...
execute as @a[tag=orace.active] run function roirtur_blitz:games/objective_race/game/evaluate_candidate
...
execute if score #tie_count orace_best matches 1 run function roirtur_blitz:games/objective_race/game/end_winner
...
execute if score #tie_count orace_best matches 2.. run function roirtur_blitz:games/objective_race/objectives/shared/next
